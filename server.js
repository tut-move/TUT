...
const server=http.createServer(async(req,res)=>{
 ...
 try{
  if(p==='/api/health')return json(res,200,{ok:true,version:'34',site:'tutmove.com',database:await dbInfo()});
...
initDB()
  .then(()=>server.listen(PORT,()=>console.log(`TUT Move v34 running on ${PORT}`)))
