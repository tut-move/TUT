...
const server=http.createServer(async(req,res)=>{
 ...
 try{
  if(p==='/api/health')return json(res,200,{ok:true,version:'27',site:'tutmove.com',database:await dbInfo()});
...
initDB()
  .then(()=>server.listen(PORT,()=>console.log(`TUT Move v27 running on ${PORT}`)))
